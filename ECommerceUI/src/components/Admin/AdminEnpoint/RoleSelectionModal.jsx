...
import { getRolesToEndpoint } from "../../../api/endpoints";

const RoleSelectionModal = ({ isOpen, onClose, onSave, menu, code }) => {
  ...
  useEffect(() => {
    const fetchRoles = async () => {
      ...
      const assignedRolesData = await getRolesToEndpoint(code, menu);
